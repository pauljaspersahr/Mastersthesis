...
void freeSurface::makePhis() const
{
    if (debug)
    {
...
void freeSurface::makeModelPtr() const                                                                              //added
{
    if (debug)
    {
...
//     if (lawPtrPtr_)
    ...
    //~ lawPtr_ = autoPtr<viscoelasticLaw>& viscoelasticLaw::New(word::null, U_, phi_, Us_, phis_, freeSurfaceProperties.subDict("rheology"));
    //~ lawPtr_ = viscoelasticLaw::New(word::null, U_, phi_, Us_, phis_, freeSurfaceProperties.subDict("rheology"));
       //~ lawPtr_.set(viscoelasticLaw::New(word::null, U_, phi_, Us_, phis_, freeSurfaceProperties.subDict("rheology")));
     //~ lawPtr_= autoPtr<viscoelasticLaw> viscoelasticLaw::New(word::null, U_, phi_, Us_, phis_, freeSurfaceProperties.subDict("rheology"));
     
     //kompiliert
       //~ autoPtr<viscoelasticLaw> pttr_= autoPtr<viscoelasticLaw> (viscoelasticLaw::New(word::null, U_, phi_, Us_, phis_, freeSurfaceProperties.subDict("rheology")));
     //~ lawPtr_.set(pttr_.ptr());
...
const edgeScalarField& freeSurface::Phis() const
{
    if (!phisPtr_)
    {
        makePhis();
...
viscoelasticModel& freeSurface::modelPtr() 							//added
{
//     if (!lawPtrPtr_)
    if (!modelPtr_)
    {
...
const viscoelasticModel& freeSurface::modelPtr() const 				//added
{
//     if (!lawPtrPtr_)
    if (!modelPtr_)
    {
