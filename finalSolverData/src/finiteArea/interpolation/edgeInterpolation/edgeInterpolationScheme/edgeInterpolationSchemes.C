...
defineTemplateRunTimeSelectionTable(edgeInterpolationScheme<diagTensor>, Mesh);
defineTemplateRunTimeSelectionTable(edgeInterpolationScheme<symmTensor4thOrder>, Mesh);
...
defineTemplateRunTimeSelectionTable(edgeInterpolationScheme<diagTensor>, MeshFlux);
defineTemplateRunTimeSelectionTable(edgeInterpolationScheme<symmTensor4thOrder>, MeshFlux);
