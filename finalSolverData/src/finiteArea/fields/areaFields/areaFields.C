...
defineTemplateTypeNameAndDebug(areaSymmTensor4thOrderField::DimensionedInternalField, 0);
defineTemplateTypeNameAndDebug(areaDiagTensorField::DimensionedInternalField, 0);
...
defineTemplateTypeNameAndDebug(areaSymmTensor4thOrderField, 0);
defineTemplateTypeNameAndDebug(areaDiagTensorField, 0);
