...
defineTemplateTypeNameAndDebug(edgeSymmTensor4thOrderField::DimensionedInternalField, 0);
defineTemplateTypeNameAndDebug(edgeDiagTensorField::DimensionedInternalField, 0);
...
defineTemplateTypeNameAndDebug(edgeSymmTensor4thOrderField, 0);
defineTemplateTypeNameAndDebug(edgeDiagTensorField, 0);
