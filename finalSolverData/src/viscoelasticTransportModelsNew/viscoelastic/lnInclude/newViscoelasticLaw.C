...
)
{
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalErrorIn
        (
            "viscoelasticLaw::New(const word& name, const volVectorField&, "                        //error massage does not contain all new arguments
    ...
    return autoPtr<viscoelasticLaw>(cstrIter()(name, U, phi, Us, phis, dict));
}
